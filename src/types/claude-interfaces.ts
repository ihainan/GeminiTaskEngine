...
export interface ConfigurationBuilder {
   ...
   */
  buildConfiguration(request: TaskRequest): Promise<any>;
...
export interface PromptStrategy {
   ...
   */
  buildPrompt(request: TaskRequest, config?: any): Promise<string>;
  
  /**
   * Get the system prompt to use
   */
  getSystemPrompt(config?: any): Promise<string | undefined>;
